...
public class TrustLocationPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
        ...
        binding.addOnNewIntentListener(intent -> false);

        // Pindahan dari onResume
        ...
        binding.addRequestPermissionsResultListener((requestCode, permissions, grantResults) -> {
            if (locationAssistantListener != null) {
                locationAssistantListener.getAssistant().onPermissionsUpdated(requestCode, grantResults);
            }
            return false;
        });
    }
